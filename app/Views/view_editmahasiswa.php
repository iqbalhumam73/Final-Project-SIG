        ...
        <div class="row">
            <div class="col-8">
                <ul>
                    ...
                    <form action="/mahasiswaController/update/<?= $mahasiswa['mhs_nrp']; ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="mb-3">
                            <label for="mhs_nama" class="form-label">Nama Lengkap</label>
                            <input type="name" class="form-control <?= ($validation->hasError('mhs_nama')) ? 'is-invalid' : ''; ?>" id="mhs_nama" name="mhs_nama" autofocus value="<?= $mahasiswa['mhs_nama'] ?>">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control <?= ($validation->hasError('mhs_urutan')) ? 'is-invalid' : ''; ?>" id="mhs_urutan" name="mhs_urutan" value="<?= $mahasiswa['mhs_urutan'] ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="name" class="form-control <?= ($validation->hasError('mhs_asalsekolah')) ? 'is-invalid' : ''; ?>" id="mhs_asalsekolah" name="mhs_asalsekolah" value="<?= $mahasiswa['mhs_asalsekolah'] ?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="name" class="form-control <?= ($validation->hasError('mhs_alamat')) ? 'is-invalid' : ''; ?>" id="mhs_alamat" name="mhs_alamat" value="<?= $mahasiswa['mhs_alamat'] ?>">
                            <div class="invalid-feedback">
